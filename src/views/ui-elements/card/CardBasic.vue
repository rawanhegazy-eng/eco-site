...
<div>
 ...
 <div class="carousel-example ">
        <swiper :options="swiperOption" :dir="$vs.rtl ? 'rtl' : 'ltr'" :key="$vs.rtl" style="height:450px">
            <swiper-slide>
              <img class="responsive" src="@/assets/images/new.jpg" alt="banner">
            </swiper-slide>
            <swiper-slide>
              <img class="responsive" src="@/assets/images/mining-440743_1280.jpg" alt="banner">
            </swiper-slide>
             <swiper-slide>
              <img class="responsive" src="@/assets/images/8.jpg" alt="banner">
            </swiper-slide>
    ...
    <div style="background-color:#eee ; padding:50px;padding-bottom:20px;">
    <h1>Main Categories</h1>
    <div class="row mt-10 mb-10">
    <div class="col-md-4" v-for="k in categoryOptions" :key="k">
      
      <div class="card card-1 mb-10" @click="product(k.id)">
...
<vs-divider style="backgroud-color:#eee;"/>
<div style="padding-top:5px; padding:50px">
    <h1>All Products</h1>
     <div class="carousel-example">
...
export default{
 ...
 swiper,
    ...
    methods:{
details(data){
    this.$router.push({name:'details', params:{productId:data.id}}) 
},
product(data){
    this.$router.push({name:'product', params:{categoryId:data}}) 
}
    },
   async created() {
