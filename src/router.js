...
const router = new Router({
    ...
    // =============================================================================
        ...
        // =============================================================================
        {
            path: '/eco/main',
            name: 'eco-main',
            component: () => import('./views/eco/main.vue'),
            meta: {
                rule: 'editor',
            }
        },
        {
            path: '/eco/details/:productId',
            name: 'eco-details',
            component: () => import('./views/eco/details.vue'),
            meta: {
                rule: 'editor',
            }
        },
        {
            path: '/eco/product/:categoryId',
            name: 'product',
            component: () => import('./views/eco/product.vue'),
           // meta: {
           //     rule: 'editor',
           // }
        },
        ...
        // =============================================================================
                ...
                */
                ...
                {
                    path: '/apps/eCommerce/ECommerceShop',
                    name: 'ecommerce-shhop',
                    component: () => import('./views/apps/eCommerce/ECommerceShop.vue'),
                },
                {
                    path: '/apps/eCommerce/ECommerceCheckout',
                    name: 'ecommerce-check',
                    component: () => import('./views/apps/eCommerce/ECommerceCheckout.vue'),
                },
                {
        ...
        // =============================================================================
                ...
                {
                    path: '/ui-elements/card/details/:productId',
                    name: 'details',
                    component: () => import('./views/ui-elements/card/details.vue'),
                   /* meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Card' },
